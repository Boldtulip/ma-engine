...
from ma_engine.agent.prompts import DOSSIER_REQUEST, SYSTEM_PROMPT
from ma_engine.matching.matcher import BuyerMatch, load_knowledge, match_buyers
from ma_engine.scoring.engine import ScoreReport

DEFAULT_MODEL = os.environ.get("MA_ENGINE_LLM_MODEL", "claude-opus-5")
...
def template_dossier(report: ScoreReport, matches: list[BuyerMatch]) -> str:
    ...
    lines += [
        ...
        "",
        "---",
        "*Generated by MA Engine. Scores are screening aids computed "
